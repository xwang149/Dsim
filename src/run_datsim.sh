...
# echo "run with FIFO-U on case1"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case1.conf --sched-policy=2 --output=../results/datsim_output_case1_U.log > ../results/case1_U.output
# ./simviz.py -e ../results/datsim_output_case1_U.log 

# echo "run with SJF on case1"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case1.conf --sched-policy=1 --output=../results/datsim_output_case1_P.log > ../results/case1_P.output
# ./simviz.py -e ../results/datsim_output_case1_P.log

# echo "run with SJF-U on case1"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case1.conf --sched-policy=3 --output=../results/datsim_output_case1_PU.log > ../results/case1_PU.output
...
# echo "run with FIFO-U on case2"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case2.conf --sched-policy=2 --output=../results/datsim_output_case2_U.log > ../results/case2_U.output
# ./simviz.py -e ../results/datsim_output_case2_U.log 

# echo "run with SJF on case2"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case2.conf --sched-policy=1 --output=../results/datsim_output_case2_P.log > ../results/case2_P.output
# ./simviz.py -e ../results/datsim_output_case2_P.log

# echo "run with SJF-U on case2"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case2.conf --sched-policy=3 --output=../results/datsim_output_case2_PU.log > ../results/case2_PU.output
...
# echo "run with FIFO-U on case3"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case3.conf --sched-policy=2 --output=../results/datsim_output_case3_U.log > ../results/case3_U.output
# ./simviz.py -e ../results/datsim_output_case3_U.log 

# echo "run with SJF on case3"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case3.conf --sched-policy=1 --output=../results/datsim_output_case3_P.log > ../results/case3_P.output
# ./simviz.py -e ../results/datsim_output_case3_P.log

# echo "run with SJF-U on case3"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case3.conf --sched-policy=3 --output=../results/datsim_output_case3_PU.log > ../results/case3_PU.output
...
# echo "run with FIFO-U on case4"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case4.conf --sched-policy=2 --output=../results/datsim_output_case4_U.log > ../results/case4_U.output
# ./simviz.py -e ../results/datsim_output_case4_U.log 

# echo "run with SJF on case4"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case4.conf --sched-policy=1 --output=../results/datsim_output_case4_P.log > ../results/case4_P.output
# ./simviz.py -e ../results/datsim_output_case4_P.log

# echo "run with SJF-U on case4"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case4.conf --sched-policy=3 --output=../results/datsim_output_case4_PU.log > ../results/case4_PU.output
...
# echo "run with FIFO-U on case5"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case5.conf --sched-policy=2 --output=../results/datsim_output_case5_U.log > ../results/case5_U.output
# ./simviz.py -e ../results/datsim_output_case5_U.log 

# echo "run with SJF on case5"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case5.conf --sched-policy=1 --output=../results/datsim_output_case5_P.log > ../results/case5_P.output
# ./simviz.py -e ../results/datsim_output_case5_P.log

# echo "run with SJF-U on case5"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case5.conf --sched-policy=3 --output=../results/datsim_output_case5_PU.log > ../results/case5_PU.output
# ./simviz.py -e ../results/datsim_output_case5_PU.log 

# echo "run with FIFO on case6"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case6.conf --sched-policy=0 --output=../results/datsim_output_case6_FIFO.log > ../results/case6_FIFO.output
# ./simviz.py -e ../results/datsim_output_case6_FIFO.log

# echo "run with FIFO-U on case6"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case6.conf --sched-policy=2 --output=../results/datsim_output_case6_U.log > ../results/case6_U.output
# ./simviz.py -e ../results/datsim_output_case6_U.log 

# echo "run with SJF on case6"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case6.conf --sched-policy=1 --output=../results/datsim_output_case6_P.log > ../results/case6_P.output
# ./simviz.py -e ../results/datsim_output_case6_P.log

# echo "run with SJF-U on case6"
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case6.conf --sched-policy=3 --output=../results/datsim_output_case6_PU.log > ../results/case6_PU.output
# ./simviz.py -e ../results/datsim_output_case6_PU.log 
