...
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case4.conf --sched-policy=1 --output=../results/datsim_output_case4_U.log > ../results/case4_U.output
...
# ./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobs.trace --synch=1 --trans-limit=trans-limit-case5.conf --sched-policy=1 --output=../results/datsim_output_case5_U.log > ../results/case5_U.output
...
echo "run with utility on case1"
./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobsx2.trace --synch=1 --trans-limit=trans-limit-case1.conf --sched-policy=1 --output=../results/datsim_output_case1_U_x2.log > ../results/case1_U_x2.output
./simviz.py -e ../results/datsim_output_case1_U_x2.log 
...
echo "run with utility on case2"
./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobsx2.trace --synch=1 --trans-limit=trans-limit-case2.conf --sched-policy=1 --output=../results/datsim_output_case2_U_x2.log > ../results/case2_U_x2.output
./simviz.py -e ../results/datsim_output_case2_U_x2.log 
...
echo "run with utility on case3"
./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobsx2.trace --synch=1 --trans-limit=trans-limit-case3.conf --sched-policy=1 --output=../results/datsim_output_case3_U_x2.log > ../results/case3_U_x2.output
./simviz.py -e ../results/datsim_output_case3_U_x2.log 
...
echo "run with utility on case4"
./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobsx2.trace --synch=1 --trans-limit=trans-limit-case4.conf --sched-policy=1 --output=../results/datsim_output_case4_U_x2.log > ../results/case4_U_x2.output
./simviz.py -e ../results/datsim_output_case4_U_x2.log 
...
echo "run with utility on case5"
./datsim --codes-config=datsim_wan_three_site.conf --jobtrace=jobsx2.trace --synch=1 --trans-limit=trans-limit-case5.conf --sched-policy=1 --output=../results/datsim_output_case5_U_x2.log > ../results/case5_U_x2.output
./simviz.py -e ../results/datsim_output_case5_U_x2.log 